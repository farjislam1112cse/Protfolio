...
const Banner = () => {
    return (
        <div id='home' className='section flex items-center min-h-[85vh] lg:min-h-[70vh] mt-12'>
            <div className='container mx-auto flex items-center flex-col lg:flex-row'>
                ...
                <div className=' w-full lg:w-[60%]'>
                    ...
                    <motion.p variants={fadeIn('up', 0.5)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='mb-8 max-w-lg mx-auto lg:mx-0 lg:text-left text-center'>
                    ...
                    <motion.div variants={fadeIn('up', 0.6)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='flex gap-x-6 max-w-max mx-auto lg:mx-0 mb-12  items-center '>
                        <button className='btn btn-lg'>contact me</button>
                        <a href='' className='text-gradient btn-link'>my protfolio</a>
                    </motion.div>
                    {/* social */}
                    <motion.div variants={fadeIn('up', 0.7)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0 py-3'>
                ...
                <motion.div variants={fadeIn('down', 0.5)} initial="hidden" whileInView={'show'} className=' w-full lg:w-[30%] max-w-max mx-auto lg:mx-0 '>
                    ...
                    <img className=' max-w-full rounded-full  bg-gradient-to-r from-[#B809C3] to-[#260129]' src={Image} alt="" />
